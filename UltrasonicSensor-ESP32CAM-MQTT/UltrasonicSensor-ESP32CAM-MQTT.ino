/*
 * Lectura del sensor ultrasonic HC-SRC4 con el ESP32CAM Y MQTT
 * por: Hugo Escalpelo
 * Fecha: 01 de octubre de 2021
 * 
 * Este programa lee el sensor ultrsonico con la biblioteca Ultrasonic de Erik Simoes
 * en su version 3.0.0 se mesclan en el programa SP32CAM-MQTT.basic del repositorio de
 * còdigo IoT
